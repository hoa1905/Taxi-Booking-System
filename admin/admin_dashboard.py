...
class AdminDashboard(customtkinter.CTk):
    def __init__(self, main):
        ...
        file.add_command(label="Tài khoản")
        file.add_separator()
        ...
        def assign_driver_gui():
            ...
            def cancel_booking():
                update_booking_result = update_booking11(bookingid.get())
            ...
            assign_booking_frame2 = customtkinter.CTkFrame(
                master=root, width=1050, fg_color="#FFFFFF"
            )
            ...
            def update_customer_booking():
                ...
                if bookingid.get() == "":
                    ...
                    if date3 < today720:
                        ...
                        driver = DriverLibs(
                            did=driver_id_combo.get(), driverstatus="Booked"
                        )
        ...
        view_customer_btn.place(x=40, y=400)
        ...
        frame_center = customtkinter.CTkFrame(
            master=self.main, width=1200, height=650, corner_radius=20
        )
        ...
        booking_table_tree_view2.column("bookingid", width=180, anchor=CENTER)
        booking_table_tree_view2.column("pickup", width=240, anchor=CENTER)
        booking_table_tree_view2.column("date", width=150, anchor=CENTER)
        booking_table_tree_view2.column("time", width=150, anchor=CENTER)
        booking_table_tree_view2.column("dropoff", width=220, anchor=CENTER)
        booking_table_tree_view2.column("status", width=220, anchor=CENTER)
        booking_table_tree_view2.column("customerid", width=150, anchor=CENTER)
        ...
        booking_table_tree_view2.heading(
            "customerid", text="Mã khách hàng", anchor=CENTER
        )
