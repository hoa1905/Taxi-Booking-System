...
class Register(customtkinter.CTk):
    def __init__(self, root):
        ...
        back_image = Image.open(
            "D:/VKU/Nam IV_Ky II/Lap trinh Python/Cuoi ky/Taxi Booking System/Images/back.png"
        )
        ...
        name_txt.configure(text_variable=self.name_txt)
        ...
        mobile_txt.configure(text_variable=self.mobile_txt)
        ...
        address_txt.configure(text_variable=self.address_txt)
        ...
        email_txt.configure(text_variable=self.email_txt)
        ...
        password_txt.configure(text_variable=self.password_txt)
        ...
        credit_txt.configure(text_variable=self.credit_txt)
